...
sales_by_day <- as_tibble(merge(sales_by_day, subsidiaries, by="subsidiary_id"))
sales_by_week <- as_tibble(merge(sales_by_week, subsidiaries, by="subsidiary_id"))
sales_by_month <- as_tibble(merge(sales_by_month, subsidiaries, by="subsidiary_id"))
```
